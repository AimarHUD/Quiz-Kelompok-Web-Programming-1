            ...
            <div class="card p-4 border-0">
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-md-4 text-center">
                        <?php $foto = $row['foto'] ?? ''; ?>
                        <?php if ($foto): ?>
                            <img src="<?php echo BASE_URL; ?>/assets/uploads/profiles/<?php echo e($foto); ?>" alt="Foto Profil" class="rounded-circle shadow" style="width: 180px; height: 180px; object-fit: cover;">
                        <?php else: ?>
                    ...
                    <div class="col-md-8">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="fw-bold fs-5"><?php echo e($row['created_at']); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
